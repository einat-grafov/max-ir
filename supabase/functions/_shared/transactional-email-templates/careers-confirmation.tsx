...
const CareersConfirmationEmail = ({ name }: Props) => (
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          We have received your application and appreciate your interest in joining {SITE_NAME}.
        </Text>
        <Text style={text}>
          Our team will review your application and get back to you if there's a good fit. We appreciate your patience during the review process.
        </Text>
...
export const template = {
  component: CareersConfirmationEmail,
  subject: 'We received your application',
  displayName: 'Careers application confirmation',
  previewData: { name: 'Sarah Johnson' },
