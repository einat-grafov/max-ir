    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-maxir-white">User Management</h1>
        </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-white/10">
              <th className="text-left text-maxir-gray font-medium px-6 py-3">User</th>
              <th className="text-left text-maxir-gray font-medium px-6 py-3">Email</th>
              <th className="text-left text-maxir-gray font-medium px-6 py-3">Role</th>
              <th className="text-left text-maxir-gray font-medium px-6 py-3">Status</th>
              <th className="text-right text-maxir-gray font-medium px-6 py-3">Actions</th>
            </tr>
          </thead>
          <tbody>
