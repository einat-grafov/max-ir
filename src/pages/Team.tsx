    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[500px] flex items-center overflow-hidden section-dark">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 lg:px-10 pt-20">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-maxir-white">The Team</h1>
        </div>
      </section>
      ...
      <section className="section-white py-16 lg:py-24">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-12">Our Story</h2>
      ...
      <section className="section-dark py-16 lg:py-24">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
          <div className="accent-line mb-6" />
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-maxir-white mb-12">Our Team</h2>
      ...
      <section className="section-white py-16 lg:py-24">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
          <div className="accent-line mb-6" />
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-12">Advisory Board</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section id="Publications" className="section-dark py-16 lg:py-24">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
          <div className="accent-line mb-6" />
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-maxir-white mb-4">Publications and announcements</h2>
      ...
      <section id="FCOI" className="section-white py-16 lg:py-24">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
          <div className="accent-line mb-6" />
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8">FCOI</h2>
