        ...
        <ScrollReveal delay={0.15} variant="fadeIn">
          <div className="relative flex items-center">
            ...
            <div className="overflow-hidden flex-1">
              ...
              >
                {awards.map((award, i) => (
                  <div key={i} className="flex-shrink-0 px-4 flex" style={{ width: `${100 / visibleCount}%` }}>
                    <div className="bg-white rounded-[16px] shadow-[0_8px_36px_#0000000d] p-8 flex flex-col items-center text-center w-full">
