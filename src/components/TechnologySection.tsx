const TechnologySection = () => {
  ...
  return (
    <section id="Technology" className="section-dark py-16 lg:py-24">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
        <div className="accent-line mb-6" />
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-maxir-white mb-8">The Technology</h2>

        <p className="text-maxir-white/70 text-base md:text-lg leading-relaxed mb-6 max-w-4xl">
        ...
        <p className="text-maxir-white/70 text-sm md:text-base leading-relaxed mb-6 max-w-4xl">
        ...
        <p className="text-maxir-white/70 text-sm md:text-base leading-relaxed mb-12 max-w-4xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          {features.map((f) => (
            <div key={f.title} className="flex flex-col items-center text-center gap-4">
              ...
              <h3 className="text-maxir-white text-sm font-semibold">{f.title}</h3>
            </div>
          ))}
        </div>
      </div>
