...
const HeroSection = ({ content, showDecorations = true, compact = false }: { content?: HeroContent | null; showDecorations?: boolean; compact?: boolean }) => {
  ...
  return (
    <section
      ref={sectionRef}
      className={`relative flex ${compact ? 'items-center' : 'items-start'} justify-center overflow-x-clip section-dark ${compact ? 'min-h-[50vh] md:min-h-[60vh] pt-[60px] md:pt-[80px]' : 'min-h-[85vh] md:min-h-screen pt-[120px] md:pt-[160px]'}`}
