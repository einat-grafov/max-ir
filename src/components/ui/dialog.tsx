...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("sticky bottom-0 z-10 bg-background pt-4 -mx-6 -mb-6 px-6 pb-6 mt-4 flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 border-t border-border", className)} {...props} />
);
