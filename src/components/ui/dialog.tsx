...
const DialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      "sticky top-0 z-10 -mx-6 -mt-6 mb-4 border-b border-border bg-background px-6 pt-4 pb-3 pr-12 flex flex-col space-y-1.5 text-center sm:text-left",
      className,
    )}
    {...props}
  />
...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      "-mx-6 mt-4 flex flex-col-reverse gap-2 border-t border-border bg-background px-6 pt-4 pb-4 sm:flex-row sm:justify-end",
      className,
    )}
    {...props}
  />
